...
<div id="entry" <?php echo $entryCss; ?>>
    <form action="" method="post">
        ...
        <label><span class="entrylabel">TEL</span><input type="tel" name="TEL" size="15" required></label>
        <label><span class="entrylabel">Email</span><input type="mail" name="Email" size="40" required></label>
...
<label><span class="entrylabel">TEL</span><input type="tel" name="TEL" size="15" value="<?php echo $tel; ?>" required></label>
<label><span class="entrylabel">Email</span><input type="mail" name="Email" size="40" value="<?php echo $email; ?>" required></label>
